...
class Ui_Curve_measure_widget(object):
    def setupUi(self, Curve_measure_widget):
        ...
        self.btn_redo = QPushButton(self.w_measure)
        self.btn_redo.setObjectName(u"btn_redo")
        self.btn_redo.setEnabled(False)
        sizePolicy4 = QSizePolicy(QSizePolicy.Fixed, QSizePolicy.Fixed)
        sizePolicy4.setHorizontalStretch(0)
        sizePolicy4.setVerticalStretch(0)
        sizePolicy4.setHeightForWidth(self.btn_redo.sizePolicy().hasHeightForWidth())
        self.btn_redo.setSizePolicy(sizePolicy4)
        self.btn_redo.setMinimumSize(QSize(30, 0))
        icon1 = QIcon()
        icon1.addFile(u":/icons/qt_resources/arrow-circle-225-left.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_redo.setIcon(icon1)

        self.lo_measure_ctrls.addWidget(self.btn_redo)
        ...
        self.widget = QWidget(self.lo_measure)
        ...
        self.plot_measurement = PgPlot(self.widget)
        ...
        self.pv = PointView(self.widget)
        self.pv.setObjectName(u"pv")
        sizePolicy7.setHeightForWidth(self.pv.sizePolicy().hasHeightForWidth())
        self.pv.setSizePolicy(sizePolicy7)

        self.horizontalLayout_8.addWidget(self.pv)

        self.lo_measure.addWidget(self.widget)
    ...
    def retranslateUi(self, Curve_measure_widget):
        ...
        self.lbl_measure_settings.setText(QCoreApplication.translate("Curve_measure_widget", u"Parameter Settings", None))
...
#endif // QT_CONFIG(statustip)
        self.btn_run.setText(QCoreApplication.translate("Curve_measure_widget", u"Apply Settings", None))
#if QT_CONFIG(tooltip)
        self.btn_measure.setToolTip(QCoreApplication.translate("Curve_measure_widget", u"Measure next point", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.btn_measure.setStatusTip(QCoreApplication.translate("Curve_measure_widget", u"Start PhotoAcoustic measurement", None))
#endif // QT_CONFIG(statustip)
        self.btn_measure.setText(QCoreApplication.translate("Curve_measure_widget", u"MEASURE NEXT", None))
#if QT_CONFIG(tooltip)
        self.btn_redo.setToolTip(QCoreApplication.translate("Curve_measure_widget", u"Measure selected point again", None))
#endif // QT_CONFIG(tooltip)
        self.btn_redo.setText("")
#if QT_CONFIG(tooltip)
        self.btn_stop.setToolTip(QCoreApplication.translate("Curve_measure_widget", u"Stop measurement and send it data viewer", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.lbl_cur_param.setText(QCoreApplication.translate("Curve_measure_widget", u"Set Next Parameter", None))
