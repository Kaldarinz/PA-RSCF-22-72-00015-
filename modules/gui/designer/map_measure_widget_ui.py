...
class Ui_map_measure(object):
    def setupUi(self, map_measure):
        ...
        self.btn_hres = QPushButton(map_measure)
        self.btn_hres.setObjectName(u"btn_hres")
        self.btn_hres.setEnabled(False)
        sizePolicy3.setHeightForWidth(self.btn_hres.sizePolicy().hasHeightForWidth())
        self.btn_hres.setSizePolicy(sizePolicy3)
        icon4 = QIcon()
        icon4.addFile(u":/icons/qt_resources/image-sharpen.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_hres.setIcon(icon4)
        self.btn_hres.setCheckable(True)

        self.horizontalLayout_4.addWidget(self.btn_hres)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/icons/qt_resources/control-pause.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_pause.setIcon(icon6)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/icons/qt_resources/arrow-circle-225-left.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/icons/qt_resources/control-stop-square.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/icons/qt_resources/SCAN_HTL.png", QSize(), QIcon.Normal, QIcon.Off)
        self.cb_scandir.addItem(icon9, "")
        icon10 = QIcon()
        icon10.addFile(u":/icons/qt_resources/SCAN_HTR.png", QSize(), QIcon.Normal, QIcon.Off)
        self.cb_scandir.addItem(icon10, "")
        icon11 = QIcon()
        icon11.addFile(u":/icons/qt_resources/SCAN_HBR.png", QSize(), QIcon.Normal, QIcon.Off)
        self.cb_scandir.addItem(icon11, "")
        icon12 = QIcon()
        icon12.addFile(u":/icons/qt_resources/SCAN_HBL.png", QSize(), QIcon.Normal, QIcon.Off)
        self.cb_scandir.addItem(icon12, "")
        icon13 = QIcon()
        icon13.addFile(u":/icons/qt_resources/SCAN_VBR.png", QSize(), QIcon.Normal, QIcon.Off)
        self.cb_scandir.addItem(icon13, "")
        icon14 = QIcon()
        icon14.addFile(u":/icons/qt_resources/SCAN_VBL.png", QSize(), QIcon.Normal, QIcon.Off)
        self.cb_scandir.addItem(icon14, "")
        icon15 = QIcon()
        icon15.addFile(u":/icons/qt_resources/SCAN_VTR.png", QSize(), QIcon.Normal, QIcon.Off)
        self.cb_scandir.addItem(icon15, "")
        icon16 = QIcon()
        icon16.addFile(u":/icons/qt_resources/SCAN_VTL.png", QSize(), QIcon.Normal, QIcon.Off)
        self.cb_scandir.addItem(icon16, "")
...
#if QT_CONFIG(tooltip)
        self.btn_hres.setToolTip(QCoreApplication.translate("map_measure", u"Toogle image smoothing", None))
#endif // QT_CONFIG(tooltip)
